...
public enum ErrorCode {
    ...
    INVALID_BOOKING_DATE("SCS-7006", "SCS-7006", "BOOKING_SCHEDULE", "Invalid booking date", "error.invalid_booking_date"),
    BUSINESS_HOURS_NOT_FOUND("SCS-7007", "SCS-7007", "BOOKING_SCHEDULE", "Business hours not found or not configured", "error.business_hours_not_found"),
    BRANCH_CLOSED("SCS-7008", "SCS-7008", "BOOKING_SCHEDULE", "Branch is closed on this day", "error.branch_closed"),
