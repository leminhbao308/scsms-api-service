...
public interface ProductRepository extends JpaRepository<Product, UUID>, JpaSpecificationExecutor<Product> {
    ...
    List<Product> findByProductTypeProductTypeIdAndIsActiveTrueAndIsDeletedFalse(
    ...
    // Find reward products (products for gifting only)
    List<Product> findByIsRewardTrueAndIsActiveTrueAndIsDeletedFalse();

    // Find sellable products (not reward products)
    List<Product> findByIsRewardFalseAndIsActiveTrueAndIsDeletedFalse();
