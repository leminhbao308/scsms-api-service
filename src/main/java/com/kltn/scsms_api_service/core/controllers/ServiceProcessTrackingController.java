...
public class ServiceProcessTrackingController {
        ...
        // PermissionConstant.SERVICE_PROCESS_TRACKING_CREATE })
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> createTracking(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService
                                .createTracking(request);
        ...
        public ResponseEntity<BaseResponseData<Page<ServiceProcessTrackingInfoDto>>> getTrackings(
                ...
                Page<ServiceProcessTrackingInfoDto> response = serviceProcessTrackingManagementService
                                .getAllTrackings(pageable);
        ...
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> updateTracking(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.updateTracking(
                                trackingId,
                                request);
        ...
        // @RequirePermission(permissions = {
        // PermissionConstant.SERVICE_PROCESS_TRACKING_DELETE })
        ...
        public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getTrackingsByBooking(
                ...
                List<ServiceProcessTrackingInfoDto> response = serviceProcessTrackingManagementService
                                .getTrackingsByBooking(bookingId);

                return ResponseEntity
                                .ok(new BaseResponseData<>(true, "Lấy danh sách tracking theo booking thành công",
                                                response));
        }

        /**
         * Lấy tracking theo kỹ thuật viên (DEPRECATED - technicians are now assigned to
         * bays)
         */
        @GetMapping(ApiConstant.GET_SERVICE_PROCESS_TRACKINGS_BY_TECHNICIAN_API)
        @SwaggerOperation(summary = "Lấy tracking theo kỹ thuật viên (DEPRECATED)", description = "DEPRECATED: Lấy danh sách tracking theo kỹ thuật viên. Technicians are now assigned to bays. Use getTrackingsByBay instead.")
        // @RequirePermission(permissions = {
        // PermissionConstant.SERVICE_PROCESS_TRACKING_READ })
        public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getTrackingsByTechnician(
                ...
                log.warn("DEPRECATED: getTrackingsByTechnician called for technician: {}. Use getTrackingsByBay instead.",
                                technicianId);
                ...
                return ResponseEntity
                                .ok(new BaseResponseData<>(true,
                                                "DEPRECATED: Lấy danh sách tracking theo kỹ thuật viên thành công. Use getTrackingsByBay instead.",
                                                response));
        }
        ...
        public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getTrackingsByBay(
                ...
                List<ServiceProcessTrackingInfoDto> response = serviceProcessTrackingManagementService
                                .getTrackingsByBay(bayId);

                return ResponseEntity.ok(
                                new BaseResponseData<>(true, "Lấy danh sách tracking theo bay thành công", response));
        }
        ...
        public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getInProgressTrackings() {
                ...
                List<ServiceProcessTrackingInfoDto> response = serviceProcessTrackingManagementService
                                .getInProgressTrackings();

                return ResponseEntity
                                .ok(new BaseResponseData<>(true, "Lấy danh sách tracking đang thực hiện thành công",
                                                response));
        }
        ...
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> startStep(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.startStep(trackingId,
                                request);
        ...
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> updateProgress(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.updateProgress(
                                trackingId,
                                request);
        ...
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> completeStep(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.completeStep(
                                trackingId,
                                request);
        ...
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> cancelStep(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.cancelStep(trackingId,
                                request);
        ...
        public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> addEvidenceMedia(
                ...
                ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.addEvidenceMedia(
                                trackingId,
