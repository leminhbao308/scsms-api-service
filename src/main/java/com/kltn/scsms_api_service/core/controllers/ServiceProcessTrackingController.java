 ...
 */
@RestController
@RequestMapping("/api/service-process-tracking")
...
public class ServiceProcessTrackingController {
    ...
    public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> createTracking(
        ...
        ServiceProcessTrackingInfoDto response = serviceProcessTrackingMapper.toServiceProcessTrackingInfoDto(savedTracking);
    ...
    public ResponseEntity<BaseResponseData<Page<ServiceProcessTrackingInfoDto>>> getTrackings(
        ...
        Page<ServiceProcessTrackingInfoDto> response = trackings.map(serviceProcessTrackingMapper::toServiceProcessTrackingInfoDto);
    ...
    public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> updateTracking(
        ...
        ServiceProcessTrackingInfoDto response = serviceProcessTrackingMapper.toServiceProcessTrackingInfoDto(updatedTracking);
    ...
    public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getTrackingsByBooking(
        ...
        return ResponseEntity.ok(new BaseResponseData<>(true, "Lấy danh sách tracking theo booking thành công", response));
    }
    ...
    public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getTrackingsByTechnician(
        ...
        return ResponseEntity.ok(new BaseResponseData<>(true, "Lấy danh sách tracking theo kỹ thuật viên thành công", response));
    }
    ...
    public ResponseEntity<BaseResponseData<List<ServiceProcessTrackingInfoDto>>> getInProgressTrackings() {
        ...
        return ResponseEntity.ok(new BaseResponseData<>(true, "Lấy danh sách tracking đang thực hiện thành công", response));
    }
     ...
     * Cập nhật tiến độ
     */
    @PutMapping("/{trackingId}/progress")
