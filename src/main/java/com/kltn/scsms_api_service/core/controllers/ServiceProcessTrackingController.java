...
public class ServiceProcessTrackingController {
    ...
    public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> updateTracking(
        ...
        ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.updateTracking(trackingId,
                request);
    ...
    public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> updateProgress(
        ...
        ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.updateProgress(trackingId,
                request);
    ...
    public ResponseEntity<BaseResponseData<ServiceProcessTrackingInfoDto>> completeStep(
        ...
        ServiceProcessTrackingInfoDto response = serviceProcessTrackingManagementService.completeStep(trackingId,
                request);
