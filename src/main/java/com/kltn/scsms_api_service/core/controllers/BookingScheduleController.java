...
public class BookingScheduleController {
    ...
    @Operation(summary = "Get available time ranges", description = "Retrieve available time ranges for booking. Frontend will handle displaying time slots from these ranges.")
    ...
    public ResponseEntity<ApiResponse<AvailableTimeRangesResponse>> getAvailableTimeRanges(
            ...
            @Parameter(description = "Booking date", required = true) @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate date) {
