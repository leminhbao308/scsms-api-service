...
public class BookingService {
    ...
    /**
     * Get booking by ID with all details (optimized to prevent N+1 queries)
     * Eagerly fetches: serviceBay, items, schedules
     * Use this method when you need full booking details to avoid N+1 queries
     */
    public Booking getByIdWithDetails(UUID bookingId) {
    ...
    public List<Booking> findByBranchAndDateTimeRange(UUID branchId, LocalDateTime startDateTime,
    ...
    public List<Booking> findCancelledBookingsInTimeRange(UUID branchId, LocalDateTime startDateTime,
            LocalDateTime endDateTime) {
     ...
     * phải cancelled
     */
    public List<Booking> findByPaymentStatusAndStatus(Booking.PaymentStatus paymentStatus,
