...
public class VehicleTypeFilterParam extends BaseFilterParam<VehicleTypeFilterParam> {
    
    public static VehicleTypeFilterParam standardize(VehicleTypeFilterParam request) {
        return request.standardizeFilterRequest(request);
    }
    
    @Override
    protected void standardizeSpecificFields(VehicleTypeFilterParam request) {
